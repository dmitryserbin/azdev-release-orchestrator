...
export class ReleaseApiRetry implements IReleaseApiRetry {
	...
	public async getReleaseDefinition(project: string, definitionId: number, propertyFilters?: string[]): Promise<ReleaseDefinition> {
		return await this.releaseApi.getReleaseDefinition(project, definitionId, propertyFilters)
	}
	...
	public async getRelease(
		...
		return await this.releaseApi.getRelease(project, releaseId, approvalFilters, propertyFilters, expand, topGateRecords)
	}
